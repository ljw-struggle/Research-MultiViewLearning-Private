...
def benchmark_2024_CVPR_MVCAN(dataset_name, batch_size, pre_epochs, train_epochs, T_1, T_2, lr, lambda_clu, seed):
...
def get_default_config(data_name):
    match data_name:
        case 'DIGIT': # [1, 32, 32] -> [1024]
            dataset_name = 'DIGIT'; seed = 0; batch_size = 256; pre_epochs = 500; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 10;
        case 'NoisyDIGIT': # [1, 32, 32] -> [1024]
            dataset_name = 'NoisyDIGIT'; seed = 0; batch_size = 256; pre_epochs = 500; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 10;
        case 'COIL': # [1, 32, 32] -> [1024]
            dataset_name = 'COIL'; seed = 3; batch_size = 256; pre_epochs = 500; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 10;
        case 'NoisyCOIL': # [1, 32, 32] -> [1024]
            dataset_name = 'NoisyCOIL'; seed = 3; batch_size = 256; pre_epochs = 500; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 10;
        case 'Amazon': # [3, 32, 32] -> [3072]
            dataset_name = 'Amazon'; seed = 1; batch_size = 256; pre_epochs = 200; train_epochs = 3000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 100;
        case 'NoisyAmazon': # [3, 32, 32] -> [3072]
            dataset_name = 'NoisyAmazon'; seed = 1; batch_size = 256; pre_epochs = 200; train_epochs = 3000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 100;
        case 'BDGP':
            dataset_name = 'BDGP'; seed = 1; batch_size = 256; pre_epochs = 200; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 10;
        case 'NoisyBDGP':
            dataset_name = 'NoisyBDGP'; seed = 1; batch_size = 256; pre_epochs = 200; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 10;
        case 'DHA':
            dataset_name = 'DHA'; seed = 1; batch_size = 256; pre_epochs = 200; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 0.1;
        case 'RGB-D':
            dataset_name = 'RGB-D'; seed = 13; batch_size = 256; pre_epochs = 200; train_epochs = 200; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 0.1;
        case 'Caltech-6V':
            dataset_name = 'Caltech-6V'; seed = 5; batch_size = 256; pre_epochs = 200; train_epochs = 1000; T_1 = 2; T_2 = 100; lr = 0.0001; lambda_clu = 0.01;
        case 'YoutubeVideo':
            dataset_name = 'YoutubeVideo'; seed = 2; batch_size = 256; pre_epochs = 50; train_epochs = 50; T_1 = 2; T_2 = 10; lr = 0.0001; lambda_clu = 10.0;
        case _:
            raise Exception(f"Dataset '{data_name}' is not supported")
    return dataset_name, seed, batch_size, pre_epochs, train_epochs, T_1, T_2, lr, lambda_clu
...
if __name__ == "__main__":
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    dataset_name, seed, batch_size, pre_epochs, train_epochs, T_1, T_2, lr, lambda_clu = get_default_config(args.dataset)
    
    acc, nmi, pur, ari = benchmark_2024_CVPR_MVCAN(dataset_name, batch_size, pre_epochs, train_epochs, T_1, T_2, lr, lambda_clu, seed)
