...
if __name__ == "__main__":
    ...
    acc, nmi, pur, ari = benchmark_2024_TMM_SCMVC(dataset_name, batch_size, learning_rate, weight_decay, pre_epochs, con_epochs, feature_dim, high_feature_dim, temperature, seed)
