...
def benchmark_2023_CVPR_GCFAgg(dataset_name, batch_size, temperature_f, learning_rate, weight_decay, mse_epochs, tune_epochs, low_feature_dim, high_feature_dim, seed):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
...
if __name__ == "__main__":
    ...
    acc, nmi, pur, ari = benchmark_2023_CVPR_GCFAgg(dataset_name, batch_size, temperature_f, learning_rate, weight_decay, mse_epochs, tune_epochs, low_feature_dim, high_feature_dim, seed)
