...
if __name__ == "__main__":
    ...
    acc, nmi, pur, ari = benchmark_2025_NIPS_SparseMVC(dataset_name, batch_size, learning_rate, pre_epochs, con_epochs, feature_dim, high_feature_dim, seed, weight_decay)
