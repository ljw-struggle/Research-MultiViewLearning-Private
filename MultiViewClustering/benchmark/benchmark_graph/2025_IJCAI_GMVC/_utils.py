...
def load_data(dataset):
    if dataset == "DHA":
        ...
        dataset = Web('data/WebKB.mat')
        dims = [2949, 334]
        view = 2
        data_size = 1051
        class_num = 2
    elif dataset == "NGs":
        dataset = NGs('data/NGs.mat')
        dims = [2000,2000,2000]
        view = 3
        data_size = 500
        class_num = 5
    elif dataset == "acm":
        dataset = ACM('data/acm.mat')
        dims = [1870,1870]
        view = 2
        data_size = 3025
        class_num = 3
    elif dataset == 'imdb':
        dataset = IMDB('data/imdb5k.mat')
        dims = [1232, 1232]
        view = 2
        data_size = 4780
        class_num = 3
        ...
        dataset = Caltech6('data/Caltech.mat')
        dims = [48, 40, 254, 928, 512, 1984]
        view = 6
        data_size = 1400
        class_num = 7
    else:
