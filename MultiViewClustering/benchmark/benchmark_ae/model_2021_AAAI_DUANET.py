...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', default='./result/data_bulk_multiomics/DAE/BRCA/', help='the output dir [default: ./result/data_bulk_multiomics/DAE/BRCA/]')
    ...
    for t in range(args.times):
        ...
        model = DAE(embed_dim=args.latent_dim, num_views=data_views, feature_dims=data_features, hidden_dims=[512, 512, 512], noise_factor=0.1).to(device)
