...
"((A:3,H:3):3,(B:2,C:2):4,(D:1,E:1):5,(H:4,G:4):2);"
...
for (k in 1:10){
  ...
  true_RNAcounts_res <- SimulateTrueCounts(ncells_total=ncells, min_popsize=50, i_minpop=1, ngenes=ngenes, nevf=10, evf_type="discrete", n_de_evf=6, vary="s", Sigma=0.6, phyla=phyla, randseed=k+1000)
  observed_RNAcounts <- True2ObservedCounts(true_counts=true_RNAcounts_res[[1]], meta_cell=true_RNAcounts_res[[3]], protocol="UMI", alpha_mean=0.00075, alpha_sd=0.0001, gene_len=gene_len, depth_mean=50000, depth_sd=3000)
  ...
  true_ADTcounts_res <- SimulateTrueCounts(ncells_total=ncells, min_popsize=50, i_minpop=1, ngenes=nadts, nevf=10, evf_type="discrete", n_de_evf=6, vary="s", Sigma=0.3, phyla=phyla2, randseed=k+1000)
  observed_ADTcounts <- True2ObservedCounts(true_counts=true_ADTcounts_res[[1]], meta_cell=true_ADTcounts_res[[3]], protocol="UMI", alpha_mean=0.045, alpha_sd=0.01, gene_len=gene_len, depth_mean=50000, depth_sd=3000)
