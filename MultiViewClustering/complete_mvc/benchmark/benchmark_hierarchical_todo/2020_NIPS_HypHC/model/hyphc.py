...
class HypHC(nn.Module):
    ...
    def __init__(self, n_nodes=1, rank=2, temperature=0.05, init_size=1e-3, max_scale=1. - 1e-3):
        ...
        self.embeddings.weight.data = project(self.scale * (2 * torch.rand((n_nodes, rank)) - 1.0))
    ...
    def loss(self, triple_ids, similarities):
        ...
        Args:
            ...
            similarities: B x 3 tensor with pairwise similarities for triples [s12, s13, s23]
        """
