    ...
    if len(arg) == 3:
        ...
        output = """ ACC {:.2f} std {:.2f} NMI {:.2f} std {:.2f} Precision {:.2f} std {:.2f}  F_measure {:.2f} std {:.2f}
         recall {:.2f} std {:.2f} ARI {:.2f} std {:.2f} AMI {:.2f} std {:.2f}""".format(
            np.mean(arg[0]) * 100, np.std(arg[0]) * 100, np.mean(arg[1]) * 100, np.std(arg[1]) * 100,
            np.mean(arg[2]) * 100, np.std(arg[2]) * 100, np.mean(arg[3]) * 100, np.std(arg[3]) * 100,
            np.mean(arg[4]) * 100, np.std(arg[4]) * 100, np.mean(arg[5]) * 100, np.std(arg[5]) * 100,
