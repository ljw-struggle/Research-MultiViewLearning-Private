import os, sys, random, math, argparse, numpy as np
import torch
...
def benchmark_2022_CVPR_MFLVC(dataset_name="MNIST-USPS",
                              batch_size=256,
                              temperature_f=0.5,
                              temperature_l=1.0,
...
if __name__ == "__main__":
    ...
    if args.dataset in con_epochs_dict: args.con_epochs = con_epochs_dict[args.dataset]
    if args.dataset in seed_dict: args.seed = seed_dict[args.dataset]
    
    nmi, ari, acc, pur = benchmark_2022_CVPR_MFLVC(
