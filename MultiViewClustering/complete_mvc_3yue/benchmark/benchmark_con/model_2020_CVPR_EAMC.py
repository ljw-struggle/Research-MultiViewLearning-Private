...
def benchmark_2020_CVPR_EAMC(dataset_name="voc",
                             batch_size=100,
                             num_epochs=500,
                             eval_interval=5,
                             t=1,
                             ...
                             discriminator_hidden_dim_list=[256, 256],
                             discriminator_output_dim=1,
                             discriminator_activation="leaky_relu",
                             discriminator_use_bias=True,
                             discriminator_use_bn=False,
                             attention_tau=10.0,
                             attention_hidden_dim_list=[100, 50],
                             attention_activation="None",
                             attention_use_bias=True,
                             attention_use_bn=False,
                             ddc_n_hidden=100,
                             ddc_use_bn=True,
                             loss_gamma=10.0,
                             loss_rel_sigma=0.15,
...
if __name__ == "__main__":
    ...
    if args.dataset == 'blobs_overlap_5':
        args.backbone_hidden_dim_list = [32, 32]; args.backbone_output_dim = 32; args.discriminator_hidden_dim_list = [32, 32, 32]; args.lr_backbones = 2e-4; args.lr_disc = 1e-5
    if args.dataset == 'blobs_overlap':
        args.backbone_hidden_dim_list = [32, 32]; args.backbone_output_dim = 32; args.discriminator_hidden_dim_list = [32, 32, 32]; args.lr_backbones = 2e-4; args.lr_disc = 1e-5
    if args.dataset == 'rgbd':
        args.backbone_hidden_dim_list = [200, 200]; args.backbone_output_dim = 500; args.lr_backbones = 6e-5; args.lr_disc = 2e-5
    
    nmi, ari, acc, pur = benchmark_2020_CVPR_EAMC(
        ...
        betas_backbones=args.betas_backbones,
        betas_disc=args.betas_disc,
        betas_att=args.betas_att,
        betas_clustering_module=args.betas_clustering_module,
        ...
        discriminator_hidden_dim_list=args.discriminator_hidden_dim_list,
        discriminator_output_dim=args.discriminator_output_dim,
        discriminator_activation=args.discriminator_activation,
        discriminator_use_bias=args.discriminator_use_bias,
        discriminator_use_bn=args.discriminator_use_bn,
        attention_tau=args.attention_tau,
        attention_hidden_dim_list=args.attention_hidden_dim_list,
        attention_activation=args.attention_activation,
        attention_use_bias=args.attention_use_bias,
        attention_use_bn=args.attention_use_bn,
