...
from model import DGRNS
from loader import DGRNS_Data
...
def main(data_path, result_path, cell, size):
    ...
    train_dataset = DGRNS_Data(exp_file=exp_file, data_file=train_file, data_cell=cell, data_size=size)
    val_dataset = DGRNS_Data(exp_file=exp_file, data_file=val_file, data_cell=cell, data_size=1)
    test_dataset = DGRNS_Data(exp_file=exp_file, data_file=test_file, data_cell=cell, data_size=1)
