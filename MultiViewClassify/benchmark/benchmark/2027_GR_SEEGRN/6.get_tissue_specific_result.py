...
def get_tissue_specific_result(tissue='Mouse-Skin', seed=8):
    ...
    model_file = '../result/DeepMixModel/tissue_specific_data/{}/mmdynamics/seed_{}/model/model_best.pth'.format(tissue, seed)
    ...
    df.to_csv('../result/DeepMixModel/tissue_specific_data/{}/output_seed_{}.csv'.format(tissue, seed), index=False)


get_tissue_specific_result(tissue='Human-Blood', seed=8)
get_tissue_specific_result(tissue='Human-Bone-Marrow', seed=8)
get_tissue_specific_result(tissue='Human-Cerebral-Cortex', seed=8)
get_tissue_specific_result(tissue='Mouse-Brain-Cortex', seed=8)
get_tissue_specific_result(tissue='Mouse-Skin', seed=8)

get_tissue_specific_result(tissue='Human-Blood', seed=16)
get_tissue_specific_result(tissue='Human-Bone-Marrow', seed=16)
get_tissue_specific_result(tissue='Human-Cerebral-Cortex', seed=16)
get_tissue_specific_result(tissue='Mouse-Brain-Cortex', seed=16)
get_tissue_specific_result(tissue='Mouse-Skin', seed=16)

get_tissue_specific_result(tissue='Human-Blood', seed=24)
get_tissue_specific_result(tissue='Human-Bone-Marrow', seed=24)
get_tissue_specific_result(tissue='Human-Cerebral-Cortex', seed=24)
get_tissue_specific_result(tissue='Mouse-Brain-Cortex', seed=24)
get_tissue_specific_result(tissue='Mouse-Skin', seed=24)

get_tissue_specific_result(tissue='Human-Blood', seed=32)
get_tissue_specific_result(tissue='Human-Bone-Marrow', seed=32)
get_tissue_specific_result(tissue='Human-Cerebral-Cortex', seed=32)
get_tissue_specific_result(tissue='Mouse-Brain-Cortex', seed=32)
get_tissue_specific_result(tissue='Mouse-Skin', seed=32)

get_tissue_specific_result(tissue='Human-Blood', seed=40)
get_tissue_specific_result(tissue='Human-Bone-Marrow', seed=40)
get_tissue_specific_result(tissue='Human-Cerebral-Cortex', seed=40)
get_tissue_specific_result(tissue='Mouse-Brain-Cortex', seed=40)
get_tissue_specific_result(tissue='Mouse-Skin', seed=40)
