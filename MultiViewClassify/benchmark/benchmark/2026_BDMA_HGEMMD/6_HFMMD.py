...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output_dir', default='./result/data_MOGONET/HFMMD/BRCA/', help='The output dir.')
    ...
    model = HFMMD(dim_list, hidden_dim, num_class, dropout=0.5).to(device)
    ...
    if args.verbose == 2:
        ...
        flops, params = profile(model, inputs=(data_list, pre_calc_G), verbose=True, custom_ops={HGNN_conv: count_hgnn_flops}) # return MACs and params; flops = 2 * MACs
