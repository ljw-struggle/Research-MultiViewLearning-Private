...
class HGEMMD(nn.Module):
    ...
    def forward(self, data_list, G):
        ...
        MMfeature_hypergraph = self.HGNN_1(MMfeature_mmdynamics, G) # shape: N X hidden_dim[0]
        MMfeature_hypergraph = self.HGNN_2(MMfeature_hypergraph, G) # shape: N X hidden_dim[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output_dir', default='./result/data_MOGONET_revise/HGEMMD_revise_hgnn/BRCA/', help='The output dir.')
