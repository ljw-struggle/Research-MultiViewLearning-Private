...
class HFMMD(nn.Module):
    def __init__(self, in_dim, hidden_dim, num_class, dropout):
        ...
        self.HGNN_1 = HGNN_conv(self.views*hidden_dim[0], hidden_dim[0])
        self.HGNN_2 = HGNN_conv(hidden_dim[0], hidden_dim[0])
    ...
    def forward(self, data_list, G):
        ...
        MMfeature_hypergraph = self.HGNN_2(self.HGNN_1(MMfeature, G), G) # shape: N X hidden_dim[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--data_dir', default='./data/data_MOGONET/LGG/', help='The data dir.')
    parser.add_argument('-o', '--output_dir', default='./result/data_MOGONET/HFMMD/LGG/', help='The output dir.')
